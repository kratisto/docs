...
>>    - *Configurer l'enregistrement DKIM automatiquement* : il permet de saisir automatiquement les enregistrements nécessaires pour  d'authentifier vos envois d'e-mails.
>>
