...
|**Contacts and Rights**|Sie können nicht nur den technischen Kontakt oder den Rechnungskontakt für Ihr Projekt ändern, sondern auch [weitere Kontakte hinzufügen](/pages/public_cloud/compute/change_project_contacts) (OVHcloud konto), um Ihr Projekt technisch zu verwalten. Sie können auch Benutzer hinzufügen, die nur gelesen werden (*read-only*).|
...
> [!primary]
>
> In diesem Abschnitt erhalten Sie einen Überblick über die verschiedenen Optionen zur Verwaltung der Dienste, die OVHcloud über drei Hauptwerkzeuge anbietet: das OVHcloud Kundencenter, Horizon und die OpenStack API. Jedes dieser Tools wurde speziell auf Ihre spezifischen Anforderungen zugeschnitten und basiert auf Ihrem Fachwissen, Ihren Managementvorlieben sowie Ihren Leistungs- und Anpassungsanforderungen.
>
> Die folgende Matrix vergleicht die wichtigsten Merkmale jedes Tools, um Ihnen die Auswahl der am besten zu Ihren Bedürfnissen passenden Lösung zu erleichtern. Egal ob Sie Anfänger, fortgeschrittener Benutzer oder Automatisierungsexperte sind, dieser Vergleich hilft Ihnen, die Vorteile, die Benutzerfreundlichkeit, die erforderlichen Kompetenzniveaus und die Skalierbarkeit jedes Tools besser zu verstehen.
>
...
| Erforderliches Kompetenzniveau              | Für jeden zugänglich, ideal für Anfänger oder einfache Bedürfnisse | Mittelstufe, erfordert eine gewisse Expertise (Systemadministratoren, Cloud-Ingenieure...) | Fortgeschritten, erfordert Skripting-/API-Kenntnisse (Cloud-Architekten, DevOps-Ingenieure, Automatisierungsexperten) |
| Einfache Handhabung                         | Intuitiv und zugänglich | Fortschrittlich, aber visuell | Technik |
| Individuelle Gestaltung                     | Niedrig - Ideal für schnelle Standardkonfigurationen mit begrenzter erweiterter Kontrolle | Mittel - Grafische Benutzeroberfläche, die erweiterte Einstellungen (Netzwerk, Speicher usw.) bietet, wenn auch durch die Benutzeroberfläche eingeschränkt. | Sehr hoch - Nahezu vollständige Anpassung über APIs, mit der Möglichkeit, Skripte, automatisierte Workflows und maßgeschneiderte Architekturen zu erstellen. |
