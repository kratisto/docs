...
If your computer ever stops working, you’ll need a recovery ISO to boot it up. Here's how to create it:
...
> [!warning]
>  If your network is not detected, you may need to manually configure it. Click “Configure network settings” and load any missing drivers.
...
10. Review the summary and start the restore.
